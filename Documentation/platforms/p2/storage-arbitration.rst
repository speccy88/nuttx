...
``p2-edge-flat-up-v0.1.1`` release.  All 20 published assets were downloaded
once to a fresh directory, matched the local package byte for byte, passed all
19 recorded checksums, and passed the bundled verifier after the
